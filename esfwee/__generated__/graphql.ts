...
export type GetMangaDetailsQuery = { __typename?: 'Query', Media: { __typename?: 'Media', id: number, chapters: number | null, volumes: number | null, format: MediaFormat | null, status: MediaStatus | null, description: string | null, averageScore: number | null, title: { __typename?: 'MediaTitle', romaji: string | null, english: string | null, native: string | null } | null, coverImage: { __typename?: 'MediaCoverImage', large: string | null, medium: string | null } | null } | null };

export type GetPopularMangaQueryVariables = Exact<{
  page: InputMaybe<Scalars['Int']['input']>;
  perPage: InputMaybe<Scalars['Int']['input']>;
}>;
...
export const useSearchMangaQuery = <
    ...
    return useQuery<SearchMangaQuery, TError, TData>(
      ...
      fetcher<SearchMangaQuery, SearchMangaQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, SearchMangaDocument, variables),
      options
    )};

export const GetMangaDetailsDocument = `
...
export const useGetMangaDetailsQuery = <
      TData = GetMangaDetailsQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables: GetMangaDetailsQueryVariables,
      options?: UseQueryOptions<GetMangaDetailsQuery, TError, TData>
    ) => {
    
    return useQuery<GetMangaDetailsQuery, TError, TData>(
      ['GetMangaDetails', variables],
      fetcher<GetMangaDetailsQuery, GetMangaDetailsQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetMangaDetailsDocument, variables),
      options
    )};

export const GetPopularMangaDocument = `
...
export const useGetPopularMangaQuery = <
      TData = GetPopularMangaQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables?: GetPopularMangaQueryVariables,
      options?: UseQueryOptions<GetPopularMangaQuery, TError, TData>
    ) => {
    
    return useQuery<GetPopularMangaQuery, TError, TData>(
      variables === undefined ? ['GetPopularManga'] : ['GetPopularManga', variables],
      fetcher<GetPopularMangaQuery, GetPopularMangaQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetPopularMangaDocument, variables),
      options
    )};
